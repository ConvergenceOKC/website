...
export const link_appearance = pgEnum('link_appearance', [
  'default',
  'outline',
  'destructive',
  'link',
...
export const enum_house_churches_language = pgEnum(
  'enum_house_churches_language',
  ['english', 'spanish'],
);
export const enum_house_churches_status = pgEnum('enum_house_churches_status', [
  'active',
  'inactive',
]);
...
export const enum_footer_left_column_nav_items_link_type = pgEnum(
  'enum_footer_left_column_nav_items_link_type',
  ['reference', 'custom'],
);
export const enum_footer_middle_column_nav_items_link_type = pgEnum(
  'enum_footer_middle_column_nav_items_link_type',
  ['reference', 'custom'],
);
export const enum_footer_right_column_nav_items_link_type = pgEnum(
  'enum_footer_right_column_nav_items_link_type',
  ['reference', 'custom'],
);
...
export const pages_hero_links = pgTable(
  'pages_hero_links',
  {
    ...
    link_appearance: link_appearance('link_appearance').default('link'),
  },
  (columns) => ({
...
export const pages_blocks_slider_gallery_images = pgTable(
  'pages_blocks_slider_gallery_images',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('pages_blocks_slider_gallery_images_order_idx').on(
      columns._order,
    ),
    _parentIDIdx: index('pages_blocks_slider_gallery_images_parent_id_idx').on(
      columns._parentID,
    ),
    pages_blocks_slider_gallery_images_image_idx: index(
      'pages_blocks_slider_gallery_images_image_idx',
    ).on(columns.image),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_slider_gallery.id],
      name: 'pages_blocks_slider_gallery_images_parent_id_fk',
    }).onDelete('cascade'),
  }),
);

export const pages_blocks_slider_gallery = pgTable(
  'pages_blocks_slider_gallery',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
    id: varchar('id').primaryKey(),
    showMegaTitle: boolean('show_mega_title').default(false),
    megaTitle: varchar('mega_title'),
    blockName: varchar('block_name'),
  },
  (columns) => ({
    _orderIdx: index('pages_blocks_slider_gallery_order_idx').on(
      columns._order,
    ),
    _parentIDIdx: index('pages_blocks_slider_gallery_parent_id_idx').on(
      columns._parentID,
    ),
    _pathIdx: index('pages_blocks_slider_gallery_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_slider_gallery_parent_id_fk',
    }).onDelete('cascade'),
  }),
);
...
export const _pages_v_blocks_slider_gallery_images = pgTable(
  '_pages_v_blocks_slider_gallery_images',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_slider_gallery_images_order_idx').on(
      columns._order,
    ),
    _parentIDIdx: index(
      '_pages_v_blocks_slider_gallery_images_parent_id_idx',
    ).on(columns._parentID),
    _pages_v_blocks_slider_gallery_images_image_idx: index(
      '_pages_v_blocks_slider_gallery_images_image_idx',
    ).on(columns.image),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_slider_gallery.id],
      name: '_pages_v_blocks_slider_gallery_images_parent_id_fk',
    }).onDelete('cascade'),
  }),
);

export const _pages_v_blocks_slider_gallery = pgTable(
  '_pages_v_blocks_slider_gallery',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_slider_gallery_order_idx').on(
      columns._order,
    ),
    _parentIDIdx: index('_pages_v_blocks_slider_gallery_parent_id_idx').on(
      columns._parentID,
    ),
    _pathIdx: index('_pages_v_blocks_slider_gallery_path_idx').on(
      columns._path,
    ),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_slider_gallery_parent_id_fk',
    }).onDelete('cascade'),
  }),
);
...
export const house_churches = pgTable(
  'house_churches',
  {
    id: serial('id').primaryKey(),
    ...
    language: enum_house_churches_language('language').default('english'),
    status: enum_house_churches_status('status').default('active'),
    lat: numeric('lat').notNull().default('35.54078384255158'),
    lng: numeric('lng').notNull().default('-97.45800992201534'),
    updatedAt: timestamp('updated_at', {
      mode: 'string',
      withTimezone: true,
      precision: 3,
  ...
  (columns) => ({
    house_churches_updated_at_idx: index('house_churches_updated_at_idx').on(
      columns.updatedAt,
    ),
    house_churches_created_at_idx: index('house_churches_created_at_idx').on(
      columns.createdAt,
    ),
  }),
);
...
export const payload_locked_documents_rels = pgTable(
  'payload_locked_documents_rels',
  {
    ...
    categoriesID: integer('categories_id'),
    usersID: integer('users_id'),
    'house-churchesID': integer('house_churches_id'),
  ...
  (columns) => ({
    ...
    payload_locked_documents_rels_house_churches_id_idx: index(
      'payload_locked_documents_rels_house_churches_id_idx',
    ).on(columns['house-churchesID']),
    ...
    'house-churchesIdFk': foreignKey({
      columns: [columns['house-churchesID']],
      foreignColumns: [house_churches.id],
      name: 'payload_locked_documents_rels_house_churches_fk',
    }).onDelete('cascade'),
...
export const header = pgTable(
  ...
  (columns) => ({
    header_logo_light_idx: index('header_logo_light_idx').on(columns.logoLight),
    header_logo_dark_idx: index('header_logo_dark_idx').on(columns.logoDark),
  }),
);
...
export const footer_left_column_nav_items = pgTable(
  'footer_left_column_nav_items',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    link_type:
      enum_footer_left_column_nav_items_link_type('link_type').default(
        'reference',
      ),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
  ...
  (columns) => ({
    _orderIdx: index('footer_left_column_nav_items_order_idx').on(
      columns._order,
    ),
    _parentIDIdx: index('footer_left_column_nav_items_parent_id_idx').on(
      columns._parentID,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [footer.id],
      name: 'footer_left_column_nav_items_parent_id_fk',
    }).onDelete('cascade'),
  }),
);

export const footer_middle_column_nav_items = pgTable(
  'footer_middle_column_nav_items',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    link_type:
      enum_footer_middle_column_nav_items_link_type('link_type').default(
        'reference',
      ),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
  ...
  (columns) => ({
    _orderIdx: index('footer_middle_column_nav_items_order_idx').on(
      columns._order,
    ),
    _parentIDIdx: index('footer_middle_column_nav_items_parent_id_idx').on(
      columns._parentID,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [footer.id],
      name: 'footer_middle_column_nav_items_parent_id_fk',
    }).onDelete('cascade'),
  }),
);

export const footer_right_column_nav_items = pgTable(
  'footer_right_column_nav_items',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    link_type:
      enum_footer_right_column_nav_items_link_type('link_type').default(
        'reference',
      ),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
  ...
  (columns) => ({
    _orderIdx: index('footer_right_column_nav_items_order_idx').on(
      columns._order,
    ),
    _parentIDIdx: index('footer_right_column_nav_items_parent_id_idx').on(
      columns._parentID,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [footer.id],
      name: 'footer_right_column_nav_items_parent_id_fk',
    }).onDelete('cascade'),
  }),
);

export const footer_blocks_form_block = pgTable(
  'footer_blocks_form_block',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('footer_blocks_form_block_order_idx').on(columns._order),
    _parentIDIdx: index('footer_blocks_form_block_parent_id_idx').on(
      columns._parentID,
    ),
    _pathIdx: index('footer_blocks_form_block_path_idx').on(columns._path),
    footer_blocks_form_block_form_idx: index(
      'footer_blocks_form_block_form_idx',
    ).on(columns.form),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [footer.id],
      name: 'footer_blocks_form_block_parent_id_fk',
    }).onDelete('cascade'),
  }),
);
...
export const footer = pgTable(
  'footer',
  {
    ...
    leftColumn_title: varchar('left_column_title').notNull(),
    middleColumn_title: varchar('middle_column_title').notNull(),
    rightColumn_title: varchar('right_column_title').notNull(),
    privacyPolicy: integer('privacy_policy_id').references(() => pages.id, {
      onDelete: 'set null',
    }),
    terms: integer('terms_id').references(() => pages.id, {
      onDelete: 'set null',
    }),
    updatedAt: timestamp('updated_at', {
      mode: 'string',
  ...
  (columns) => ({
    ...
    footer_privacy_policy_idx: index('footer_privacy_policy_idx').on(
      columns.privacyPolicy,
    ),
    footer_terms_idx: index('footer_terms_idx').on(columns.terms),
  }),
);
...
export const socials_platforms = pgTable(
  'socials_platforms',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('socials_platforms_order_idx').on(columns._order),
    _parentIDIdx: index('socials_platforms_parent_id_idx').on(
      columns._parentID,
    ),
    socials_platforms_icon_idx: index('socials_platforms_icon_idx').on(
      columns.icon,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [socials.id],
      name: 'socials_platforms_parent_id_fk',
    }).onDelete('cascade'),
  }),
);
...
export const relations_pages_blocks_slider_gallery_images = relations(
  pages_blocks_slider_gallery_images,
  ({ one }) => ({
    _parentID: one(pages_blocks_slider_gallery, {
      fields: [pages_blocks_slider_gallery_images._parentID],
      references: [pages_blocks_slider_gallery.id],
      relationName: 'images',
    }),
    image: one(media, {
      fields: [pages_blocks_slider_gallery_images.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
);
export const relations_pages_blocks_slider_gallery = relations(
  pages_blocks_slider_gallery,
  ({ one, many }) => ({
    _parentID: one(pages, {
      fields: [pages_blocks_slider_gallery._parentID],
      references: [pages.id],
      relationName: '_blocks_sliderGallery',
    }),
    images: many(pages_blocks_slider_gallery_images, {
      relationName: 'images',
    }),
  }),
);
...
export const relations_pages = relations(pages, ({ one, many }) => ({
  ...
  _blocks_sliderGallery: many(pages_blocks_slider_gallery, {
    relationName: '_blocks_sliderGallery',
  }),
...
export const relations__pages_v_blocks_slider_gallery_images = relations(
  _pages_v_blocks_slider_gallery_images,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_slider_gallery, {
      fields: [_pages_v_blocks_slider_gallery_images._parentID],
      references: [_pages_v_blocks_slider_gallery.id],
      relationName: 'images',
    }),
    image: one(media, {
      fields: [_pages_v_blocks_slider_gallery_images.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
);
export const relations__pages_v_blocks_slider_gallery = relations(
  _pages_v_blocks_slider_gallery,
  ({ one, many }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_slider_gallery._parentID],
      references: [_pages_v.id],
      relationName: '_blocks_sliderGallery',
    }),
    images: many(_pages_v_blocks_slider_gallery_images, {
      relationName: 'images',
    }),
  }),
);
...
export const relations__pages_v = relations(_pages_v, ({ one, many }) => ({
  ...
  _blocks_sliderGallery: many(_pages_v_blocks_slider_gallery, {
    relationName: '_blocks_sliderGallery',
  }),
...
export const relations_house_churches = relations(house_churches, () => ({}));
...
export const relations_payload_locked_documents_rels = relations(
  ...
  ({ one }) => ({
    ...
    'house-churchesID': one(house_churches, {
      fields: [payload_locked_documents_rels['house-churchesID']],
      references: [house_churches.id],
      relationName: 'house-churches',
    }),
...
export const relations_header = relations(header, ({ one, many }) => ({
  logoLight: one(media, {
    fields: [header.logoLight],
    references: [media.id],
    relationName: 'logoLight',
  }),
  logoDark: one(media, {
    fields: [header.logoDark],
    references: [media.id],
...
export const relations_footer_left_column_nav_items = relations(
  footer_left_column_nav_items,
  ({ one }) => ({
    _parentID: one(footer, {
      fields: [footer_left_column_nav_items._parentID],
      references: [footer.id],
      relationName: 'leftColumn_navItems',
    }),
  }),
);
export const relations_footer_middle_column_nav_items = relations(
  footer_middle_column_nav_items,
  ({ one }) => ({
    _parentID: one(footer, {
      fields: [footer_middle_column_nav_items._parentID],
      references: [footer.id],
      relationName: 'middleColumn_navItems',
    }),
  }),
);
export const relations_footer_right_column_nav_items = relations(
  footer_right_column_nav_items,
  ({ one }) => ({
    _parentID: one(footer, {
      fields: [footer_right_column_nav_items._parentID],
      references: [footer.id],
      relationName: 'rightColumn_navItems',
    }),
  }),
);
export const relations_footer_blocks_form_block = relations(
  footer_blocks_form_block,
  ({ one }) => ({
    _parentID: one(footer, {
      fields: [footer_blocks_form_block._parentID],
      references: [footer.id],
      relationName: '_blocks_formBlock',
    }),
    form: one(forms, {
      fields: [footer_blocks_form_block.form],
      references: [forms.id],
      relationName: 'form',
    }),
  }),
...
export const relations_footer = relations(footer, ({ one, many }) => ({
  ...
  leftColumn_navItems: many(footer_left_column_nav_items, {
    relationName: 'leftColumn_navItems',
  }),
  middleColumn_navItems: many(footer_middle_column_nav_items, {
    relationName: 'middleColumn_navItems',
  }),
  rightColumn_navItems: many(footer_right_column_nav_items, {
    relationName: 'rightColumn_navItems',
  }),
  _blocks_formBlock: many(footer_blocks_form_block, {
    relationName: '_blocks_formBlock',
  }),
  privacyPolicy: one(pages, {
    fields: [footer.privacyPolicy],
    references: [pages.id],
    relationName: 'privacyPolicy',
  }),
  terms: one(pages, {
    fields: [footer.terms],
    references: [pages.id],
...
export const relations_socials_platforms = relations(
  socials_platforms,
  ({ one }) => ({
    _parentID: one(socials, {
      fields: [socials_platforms._parentID],
      references: [socials.id],
      relationName: 'platforms',
    }),
    icon: one(media, {
      fields: [socials_platforms.icon],
      references: [media.id],
      relationName: 'icon',
    }),
  }),
...
export const relations_socials = relations(socials, ({ many }) => ({
  platforms: many(socials_platforms, {
    relationName: 'platforms',
  }),
}));
...
type DatabaseSchema = {
  ...
  link_appearance: typeof link_appearance;
  ...
  enum_house_churches_language: typeof enum_house_churches_language;
  enum_house_churches_status: typeof enum_house_churches_status;
  ...
  enum_footer_left_column_nav_items_link_type: typeof enum_footer_left_column_nav_items_link_type;
  enum_footer_middle_column_nav_items_link_type: typeof enum_footer_middle_column_nav_items_link_type;
  enum_footer_right_column_nav_items_link_type: typeof enum_footer_right_column_nav_items_link_type;
  ...
  pages_blocks_slider_gallery_images: typeof pages_blocks_slider_gallery_images;
  pages_blocks_slider_gallery: typeof pages_blocks_slider_gallery;
  pages: typeof pages;
  ...
  _pages_v_blocks_slider_gallery_images: typeof _pages_v_blocks_slider_gallery_images;
  _pages_v_blocks_slider_gallery: typeof _pages_v_blocks_slider_gallery;
  ...
  users: typeof users;
  house_churches: typeof house_churches;
  ...
  footer_left_column_nav_items: typeof footer_left_column_nav_items;
  footer_middle_column_nav_items: typeof footer_middle_column_nav_items;
  footer_right_column_nav_items: typeof footer_right_column_nav_items;
  footer_blocks_form_block: typeof footer_blocks_form_block;
  footer: typeof footer;
  footer_rels: typeof footer_rels;
  socials_platforms: typeof socials_platforms;
  ...
  relations_pages_blocks_slider_gallery_images: typeof relations_pages_blocks_slider_gallery_images;
  relations_pages_blocks_slider_gallery: typeof relations_pages_blocks_slider_gallery;
  ...
  relations__pages_v_blocks_slider_gallery_images: typeof relations__pages_v_blocks_slider_gallery_images;
  relations__pages_v_blocks_slider_gallery: typeof relations__pages_v_blocks_slider_gallery;
  ...
  relations_house_churches: typeof relations_house_churches;
  ...
  relations_footer_left_column_nav_items: typeof relations_footer_left_column_nav_items;
  relations_footer_middle_column_nav_items: typeof relations_footer_middle_column_nav_items;
  relations_footer_right_column_nav_items: typeof relations_footer_right_column_nav_items;
  relations_footer_blocks_form_block: typeof relations_footer_blocks_form_block;
  relations_footer_rels: typeof relations_footer_rels;
  relations_footer: typeof relations_footer;
  relations_socials_platforms: typeof relations_socials_platforms;
