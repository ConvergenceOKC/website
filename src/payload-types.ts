...
export interface Page {
  ...
  settings?: {
     ...
     */
    enablePageNavigator?: boolean | null;
    /**
     * Select which heading level to include in the page navigator
     */
    navigatorHeadingLevel?: ('1' | '2' | '3' | '4' | '5' | '6') | null;
  };
...
export interface MessagesBlock {
  block: 'latest' | 'moreSeries' | 'recentSeries' | 'recentMessages';
  useLatestMessage?: boolean | null;
  excludeLatestMessage?: boolean | null;
...
export interface PagesSelect<T extends boolean = true> {
  ...
  settings?:
    | T
    | {
        enablePageNavigator?: T;
        navigatorHeadingLevel?: T;
      };
  publishedAt?: T;
  slug?: T;
  slugLock?: T;
