...
export async function Footer() {
  ...
  return (
    <footer className="text-convergence-beige [&_h6]:text-convergence-beige [&_label]:text-convergence-beige/60 relative [&_h6]:text-[1rem] [&_img]:rounded-none">
        ...
        <div className="container grid grid-cols-1 items-center gap-4 md:grid-cols-5 md:gap-8">
          ...
          <div className="flex flex-col justify-center gap-2 sm:flex-row md:col-span-2 md:justify-start">
            {privacy && (
              <CMSLink
                appearance="link"
                className="text-convergence-beige/60 md:justify-left justify-center text-xs"
                reference={{
                  relationTo: 'pages',
                  value: privacy,
                }}
